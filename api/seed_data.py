...
KNOWN_INVESTMENTS = [
    ...
    },
    {
        ...
        "amount_usd": 500_000_000,
        "round_type": "growth",
        "investors": ["Amazon", "Citadel", "Ares Management"],
        "technology_type": "nuclear",
        "summary": "Amazon led a $500M Series C-1 round in X-energy to deploy SMRs near Amazon data centers.",
    },
    {
        "company": "Holtec International",
        "date": "2024-12-20",
        "amount_usd": 1_520_000_000,
        "round_type": "doe_grant",
        "investors": ["DOE LPO"],
        "technology_type": "nuclear",
        "summary": "DOE finalized $1.52B loan to Holtec for Palisades nuclear plant restart in Michigan.",
    },
    {
        ...
        "round_type": "series_g",
        "investors": ["Chevron", "Sumitomo", "Google"],
        "technology_type": "fusion",
        "summary": "TAE Technologies raised $250M for its field-reversed configuration fusion approach targeting 2030s commercialization.",
    },
    {
        "company": "Zap Energy",
        "date": "2023-07-01",
        ...
        "round_type": "series_c",
        "investors": ["Lowercarbon Capital", "Addition"],
        "technology_type": "fusion",
        "summary": "Zap Energy raised $160M for its sheared-flow Z-pinch fusion technology, aiming for a compact, low-cost reactor.",
    },
    {
        "company": "Form Energy",
        "date": "2023-10-01",
        ...
        "round_type": "series_e",
        "investors": ["T. Rowe Price", "GIC", "Bill Gates"],
        "technology_type": "storage",
        "summary": "Form Energy raised $450M for iron-air battery manufacturing, enabling 100-hour grid storage at $20/kWh.",
    },
    {
        ...
        "round_type": "seed",
        "investors": ["Lowercarbon Capital", "Y Combinator"],
        "technology_type": "fusion",
        "summary": "General Matter raised $18M seed round for compact fusion devices using novel plasma confinement in Palo Alto.",
    },
]
...
SEED_POLICY_EVENTS = [
    ...
    },
    {
        ...
        "date": "2023-01-19",
        "source_url": "https://www.nrc.gov/reactors/new-reactors/smr/licensing-activities/nuscale.html",
    ...
    },
    {
        ...
        "date": "2023-07-28",
        "source_url": "https://www.ferc.gov/news-events/news/ferc-issues-interconnection-final-rule",
        "event_type": "regulatory",
        "entities": ["FERC"],
        "dollar_amount": None,
        "sentiment": "positive",
    ...
    },
    {
        ...
        "date": "2024-05-13",
        "source_url": "https://www.congress.gov/bill/118th-congress/house-bill/1042",
        "event_type": "legislation",
    ...
    {
        "title": "DOE Issues $9.1B Conditional Loan to BlueOval SK Battery Plant",
        "date": "2024-06-21",
        "source_url": "https://www.energy.gov/lpo/loan-programs-office",
        "event_type": "funding_announcement",
        "entities": ["DOE", "Ford", "SK On"],
        "dollar_amount": 9_100_000_000,
        "sentiment": "positive",
        "summary": "DOE LPO issues $9.1B conditional loan commitment for BlueOval SK electric vehicle battery manufacturing facilities.",
    },
    {
        "title": "NRC Accepts Kairos Power Hermes 2 Construction Permit Application",
        "date": "2024-09-17",
        "source_url": "https://www.nrc.gov/reactors/new-reactors/advanced.html",
        "event_type": "regulatory",
        "entities": ["NRC", "Kairos Power"],
        "dollar_amount": None,
        "sentiment": "positive",
        "summary": "NRC accepts Kairos Power's application for Hermes 2, a 35 MWe commercial-scale fluoride salt-cooled reactor in Oak Ridge, TN.",
    },
    {
        "title": "White House Announces Nuclear Energy Deployment Goal",
        "date": "2024-11-01",
        "source_url": "https://www.whitehouse.gov/briefing-room/statements-releases/",
        "event_type": "executive_order",
        "entities": ["White House", "DOE", "NRC"],
        "dollar_amount": None,
        "sentiment": "positive",
        "summary": "Administration sets target to triple US nuclear capacity by 2050 with streamlined permitting and new federal site availability.",
    },
    {
        "title": "Constellation Energy Signs Record Nuclear PPA with Microsoft",
        "date": "2024-09-20",
        "source_url": "https://www.constellationenergy.com/newsroom.html",
        "event_type": "regulatory",
        "entities": ["Constellation Energy", "Microsoft", "NRC"],
        "dollar_amount": None,
        "sentiment": "positive",
        "summary": "Constellation Energy signs 20-year power purchase agreement with Microsoft to restart Three Mile Island Unit 1 for AI data center power.",
    },
    {
        "title": "DOE Finalizes $1.52B Loan to Holtec for Palisades Nuclear Plant Restart",
        "date": "2024-12-20",
        "source_url": "https://www.energy.gov/lpo/palisades",
        "event_type": "funding_announcement",
        "entities": ["DOE", "Holtec International"],
        "dollar_amount": 1_520_000_000,
        "sentiment": "positive",
        "summary": "DOE LPO closes $1.52B loan guarantee to Holtec International to restart the Palisades nuclear plant in Michigan — first US nuclear restart.",
    },
    {
        "title": "Google Signs Nuclear Energy Deal with Kairos Power",
        "date": "2024-10-14",
        "source_url": "https://blog.google/outreach-initiatives/sustainability/google-kairos-power-nuclear-energy-deal/",
        "event_type": "funding_announcement",
        "entities": ["Google", "Kairos Power"],
        "dollar_amount": None,
        "sentiment": "positive",
        "summary": "Google agrees to purchase nuclear energy from Kairos Power's fleet of advanced small modular reactors, targeting first delivery by 2030.",
    },
    {
        "title": "Amazon Invests in X-energy to Power Data Centers with Nuclear",
        "date": "2024-10-16",
        "source_url": "https://www.aboutamazon.com/news/sustainability",
        "event_type": "funding_announcement",
        "entities": ["Amazon", "X-energy"],
        "dollar_amount": 500_000_000,
        "sentiment": "positive",
        "summary": "Amazon leads $500M investment in X-energy and signs agreement to deploy SMRs near Amazon data centers in Washington state.",
    },
]
