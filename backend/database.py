"""Database models and initialization for GridPulse."""
...
class EnrichmentEntity(Base):
    ...
    type = Column(String(32))  # enrichment/reactor/fusion/fuel_cycle
    stage = Column(String(32))  # R&D/licensed/construction/operating
    lat = Column(Float)
    lng = Column(Float)
...
class PolicyEvent(Base):
    ...
    event_type = Column(String(32))  # legislation/executive_order/regulatory/funding/international
